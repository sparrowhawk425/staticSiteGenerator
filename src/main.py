...
def generate_pages_r(dir_path_content, template_path, dest_dir_path):
    ...
    for content_file in content_files:
        ...
        if os.path.isfile(file_path):
            ...
            generate_page(file_path, template_path, os.path.join(dest_dir_path, content_file.replace(".md", ".html")))
        if os.path.isdir(file_path):
            ...
            os.mkdir(dest_path)
            generate_pages_r(file_path, template_path, dest_path)

def main():
    copy_files_from_directory_r("static", "public")
